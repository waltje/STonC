 ...
 */
#if 0 /* LVL: changed to run both tos1 and tos2 */
#if PROTECT_ROM
#if SMALL
...
#define NORMAL_ADDRESS_W_W(_x) (((_x) >= 0x800) && ((_x) <= SMALL_MEM-2))
#define NORMAL_ADDRESS_W_L(_x) (((_x) >= 0x800) && ((_x) <= SMALL_MEM-4))
#define SHIFTER_MAX_ADDR SMALL_MEM-1
#else /* not SMALL */
#define NORMAL_ADDRESS_R_B(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-1)))
#define NORMAL_ADDRESS_R_W(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-2)))
#define NORMAL_ADDRESS_R_L(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-4)))
#define NORMAL_ADDRESS_W_B(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-1)))
#define NORMAL_ADDRESS_W_W(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-2)))
#define NORMAL_ADDRESS_W_L(_x) (((_x) >= 0x800) && ((_x) <= TRIM(0xE00000-4)))
#define SHIFTER_MAX_ADDR TRIM(0xE00000-1)
#endif /* not SMALL */
#endif /* LVL */
