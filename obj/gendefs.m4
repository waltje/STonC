dnl 
dnl gendefs.m4 - used when generation m4 code for the CPU
dnl 
dnl Taken from STonX (C) 1994-1997 Marinos Yannikos & Martin D. Griffiths
dnl Modified for STonC (C) 1998-2003 Laurent Vogel
dnl Covered by the GPL version 2 or later; see COPYING for details
...
dnl MOVE from SR is not a plain 68000 instruction according to the
dnl motorola manual. However the TOS 2.06 does not boot without it.
dnl furthermore, MOVE from SR is said to be privileged in the
dnl manual.
